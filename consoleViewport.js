...
$(document).ready(function () {
    ...
    $.get(CDNROOTDIR + 'consoleViewportUI.html', function(contents) {
    ...
    switch (page) {
        ...
        case 'channel.html':
            if (CONTEXTID) {
                ...
                var url = BASEURL + page + '?showTracker=true&trackerScale=0.8&glass=false&color=0178af&navColor=b5d7e8&fitWidth=' + fitWidth + '&fitHeight=' + fitHeight + '&contextId=' + CONTEXTID;
