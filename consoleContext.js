...
function buildUI(){
    ...
    $("#scavecgraphInfo").button({text: false,icons: {primary: "ui-icon.scavecgraph"}});
...
//            $(document).width(); // returns width of HTML document
            ...
            var url = '';
            if (CURRENTCONTEXT) {
                url = BASEURL + page + '?showTracker=true&trackerScale=0.8&glass=false&color=0178af&navColor=b5d7e8&fitWidth=' + WIDTH + '&fitHeight=' + HEIGHT + '&contextId=' + CURRENTCONTEXT;
            } else {
                url = BASEURL + page + '?showTracker=true&trackerScale=0.8&glass=false&color=0178af&navColor=b5d7e8&fitWidth=' + WIDTH + '&fitHeight=' + HEIGHT;
            }
